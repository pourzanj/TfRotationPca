...
\centering
\vspace{.1in}
\includegraphics[width=0.4\textwidth]{figures/AreaForm_atz.pdf}
\vspace{.05in}
...
\noindent The terms $dY_i$, $i = 1, \cdots, p$, are known as differential 1-forms or covectors, and they represent infinitesimal directions along the Stiefel manifold. The wedge symbol denotes the wedge product, an anticommutative operation that takes in an $r$-form and an $s$-form and results in an $(r+s)$-form. Wedge products are closely related to, and in fact a generalization of determinants. For example, the wedge product of two 1-forms results in a 2-form, a signed infinitesimal area that is used for measuring surface areas of a manifold, just as the determinant of matrix comprised of two column vectors can be used to find the area of the parallelogram formed by those two vectors.

\noindent Letting $J_{Y_i(\Theta)}(\Theta)$ be the Jacobian of the $i$th column of $Y$ with respect to the angle coordinates of the Givens representation, this differential form in Expression \ref{eq:WedgeForm} can be written in the coordinates of the Givens representation as
...
\centering
\vspace{.1in}
\includegraphics[width=0.45\textwidth]{figures/sliver_globe.png}
\vspace{.05in}
...
\centering
\vspace{.1in}
\includegraphics[width=0.6\textwidth]{figures/scaling.png}
\vspace{.05in}
...
\centering
\vspace{.1in}
\includegraphics[width=0.4\textwidth]{figures/uncertainty_atz.pdf}
\vspace{.05in}
