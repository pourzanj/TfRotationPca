...
\centering
\vspace{.1in}
\includegraphics[width=0.35\textwidth]{figures/stiefel_geom_new.png}
\vspace{.05in}
...
\centering
\vspace{.1in}
\includegraphics[width=0.6\textwidth]{figures/givens_reduction.png}
\vspace{.05in}
...
\centering
\vspace{.1in}
\includegraphics[width=0.35\textwidth]{figures/AreaForm_atz.pdf}
\vspace{.05in}
...
\noindent One way to compute the change-of-measure term analogous to the Jacobian determinant is to appeal to the algebra of differential forms, a useful tool used in geometry to measure areas, volumes, and their higher-dimensional analogues. Denote the product of $n \times n$ rotation matrices in the Givens representation by $G$, i.e. 
...
\noindent The terms $dY_i$, $i = 1, \cdots, p$, are known as differential 1-forms or covectors, and they represent infinitesimal directions along the Stiefel manifold. The wedge symbol denotes the wedge product, an anticommutative operation that takes in an $r$-form and an $s$-form and results in an $(r+s)$-form. Wedge products are closely related to, and in fact a generalization of determinants. For example, the wedge product of two 1-forms results in a 2-form, a signed infinitesimal area that is used for measuring surface areas of a manifold, just as the determinant of a matrix comprised of two column vectors can be used to find the area of the parallelogram formed by those two vectors. For a simple introduction to differential forms, wedge products, and their connection to determinants we refer the reader to the excellent set of notes by \cite{edelman200518}. For a more comprehensive overview in the context of multivariate statistics we recommend \cite{muirhead2009aspects}.

\noindent Letting $J_{Y_i(\Theta)}(\Theta)$ be the Jacobian of the $i$th column of $Y$ with respect to the angle coordinates of the Givens representation, the differential form in Expression \ref{eq:WedgeForm} can be written in the coordinates of the Givens representation as
...
\centering
\vspace{.1in}
\includegraphics[width=0.4\textwidth]{figures/sliver_globe.png}
\vspace{.05in}
...
\centering
\vspace{.1in}
\includegraphics[width=0.5\textwidth]{figures/scaling.png}
\vspace{.05in}
...
\centering
\vspace{.1in}
\includegraphics[width=0.35\textwidth]{figures/uncertainty_atz.pdf}
\vspace{.05in}
...
\centering
\vspace{.1in}
\includegraphics[width=0.55\textwidth]{figures/jauche_sim_principal_angle.png}
\vspace{.05in}
...
\centering
\vspace{.1in}
\includegraphics[width=0.7\textwidth]{figures/ppca50_coverage.png}
\vspace{.05in}
...
\noindent The latter plot illustrates how the Givens representation can be used to obtain uncertainty estimates for factor loadings in PPCA. Furthermore, both plots illustrate the duality between the geometric view of the Givens representation of orthogonal matrices described in Section \ref{givens_stiefel_geometry} and the canonical representation.
...
\centering
\vspace{.1in}
\includegraphics[width=0.9\textwidth]{figures/ppca50_coverage_sparse.png}
\vspace{.05in}
...
\centering
\vspace{.1in}
\includegraphics[width=0.5\textwidth]{figures/eigennetwork_traceplots.png}
\vspace{.05in}
