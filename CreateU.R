...
Area <- GetStiefelAreaForm(G, list(Theta01, Theta02, Theta12), n = 3, p = 2)

U <- (10000/2)*log(tf$matrix_determinant(C)) + (10000/2)*tf$trace(tf$matrix_solve(C, SigmaHat)) - log(Area)
