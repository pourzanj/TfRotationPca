...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        ...
        \label{fig:AreaForm}
    \end{subfigure}
    \caption{Visualizing the Givens Transform. (a) How the Givens Reduction ``zeros out'' a column vector. (b) A geometric view of the Stiefel manifold, two-frame in three dimensions. (c) Sampling without a proper measure adjustment. \commentPJA{The left and right figure still need work.}}\label{fig:Givens}
\end{figure}
